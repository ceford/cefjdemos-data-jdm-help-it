<!-- Filename: Help4.x:Maintenance:_Global_Check-in / Display title: Manutenzione: Check-in Globale -->
...
![controllo globale della manutenzione](../../../it/images/maintenance/maintenance-global-check-in/01-check-in-list.png)
