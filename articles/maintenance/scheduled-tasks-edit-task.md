...
![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/01-joomla-update-notofication.png)

### Scheda Avanzata

![joomla update notification advanced tab parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/02-advanced-tab.png)

### Scheda Cronologia di Esecuzione

![joomla update notification execution history tab parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/03-exec-history-tab.png)

### Dettagli Tab

![joomla update notification details tab parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/04-details-tab.png)

## Elimina Registri delle Azioni

Elimina i log delle azioni dopo i giorni specificati.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/05-delete-action-logs.png)

## Scadenza dei Consensi sulla Privacy

Gestisci la scadenza dei consensi sulla privacy.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/06-privacy-consent.png)

## Richiesta GET

Effettua richieste GET a un server. Supporta un timeout personalizzato e intestazioni di autorizzazione.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/07-get-request.png)

## Registrazione Globale

Controlla elementi contrassegnati come ritirati.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/08-global-check-in.png)
...
![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/09-image-size-check.png)
...
![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/10-rotate-logs.png)
...
![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/11-session-data-purge.png)

## Imposta Sito Offline

Imposta lo stato del sito su offline ad ogni esecuzione.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/12-set-site-offline.png)

## Metti il sito online

Imposta lo stato del sito su online a ogni esecuzione.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/13-set-site-online.png)

## Attiva/Disattiva Offline

Attiva/disattiva lo stato del sito ad ogni esecuzione.

![joomla update notification parameters](../../../it/images/maintenance/scheduled-tasks-edit-task/14-toggle-offline.png)
