...
![Elenco voci di menu Notizie in una scheda di dettaglio Categoria](../../../../it/images/menu-items/news-feeds/list-news-feeds-in-a-category/01-details-tab.png)

## Campi del Modulo

### Scheda Opzioni di Visualizzazione del Feed

![Elenco degli Oggetti nel Menu Feeds di Notizie in una Categoria scheda dettagli](../../../../it/images/menu-items/news-feeds/list-news-feeds-in-a-category/02-feed-display-options-tab.png)
