<!-- Filename: Help4.x:Menu_Item:_Single_Article / Display title: Articolo Singolo -->
...
![Voce di Menu Articoli - Scheda dettagli Articolo singolo](../../../it/images/menu-items/articles-single-article/01-details-tab.png)
