<!-- Filename: Help4.x:Menus_Menu_Item_Weblink_Submit / Display title: Invia un Link Web -->
...
![Voce di menu weblinks invia un collegamento web](../../../it/images/menu-items/weblinks-weblink-submit/01-details-tab.png)
