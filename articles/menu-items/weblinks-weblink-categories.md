...
![Tipo di voce di menu Elenca tutte le categorie di Web Link](../../../it/images/menu-items/weblinks-weblink-categories/01-details-tab.png)

## Campi del Modulo

### Scheda Categorie

![Menu elemento tipo Lista tutte le categorie di Collegamenti Web](../../../it/images/menu-items/weblinks-weblink-categories/02-categories-tab.png)
