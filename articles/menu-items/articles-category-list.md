<!-- Filename: Help4.x:Menu_Item:_Category_List / Display title: Elenco delle categorie -->
...
![Elenco delle categorie degli elementi del menu](../../../it/images/menu-items/articles-category-list/01-details-tab.png)
