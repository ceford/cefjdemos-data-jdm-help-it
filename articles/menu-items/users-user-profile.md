<!-- Filename: Help4.x:Menu_Item:_User_Profile / Display title: Profilo Utente -->
...
![Dettagli del profilo utente](../../../it/images/menu-items/users-user-profile/01-details-tab.png)
