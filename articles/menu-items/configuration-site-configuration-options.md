<!-- Filename: Help4.x:Menu_Item:_Site_Configuration_Options / Display title: Opzioni di Configurazione del Sito -->
...
![Opzioni di configurazione del sito tipo elemento di menu](../../../it/images/menu-items/configuration-site-configuration-options/01-details-tab.png)

## Schermata Front End

![Form delle opzioni di configurazione del sito nel front end](../../../en/images/menu-items/configuration-site-configuration-options/02-site-configuration-options-frontend.png)
