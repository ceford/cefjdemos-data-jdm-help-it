...
![Scheda dei dettagli del logout](../../../../it/images/menu-items/users/logout/01-details-tab.png)

## Campi del Modulo

### Scheda Opzioni

![Scheda opzioni di disconnessione](../../../../it/images/menu-items/users/logout/02-options-tab.png)
