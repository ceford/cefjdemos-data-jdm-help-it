...
![Dettagli della scheda wrapper Iframe](../../../it/images/menu-items/wrapper-iframe-wrapper/01-details-tab.png)

## Campi del Modulo

### Scheda Parametri Barra di Scorrimento

![Scheda parametri barra di scorrimento wrapper Iframe](../../../it/images/menu-items/wrapper-iframe-wrapper/02-scroll-bar-parameters-tab.png)
...
![Scheda avanzata wrapper Iframe](../../../it/images/menu-items/wrapper-iframe-wrapper/03-advanced-tab.png)
