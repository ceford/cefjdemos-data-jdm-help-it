<!-- Filename: Help4.x:Menu_Item:_Edit_User_Profile / Display title: Modifica Profilo Utente -->
...
![Modifica la scheda Dettagli del profilo utente](../../../it/images/menu-items/users-edit-user-profile/01-details-tab.png)
