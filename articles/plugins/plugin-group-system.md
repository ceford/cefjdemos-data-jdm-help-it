...
![Modulo delle funzionalità di accessibilità aggiuntive del sistema](../../../en/images/plugins/plugin-group-system/01-plugin-group-system-additional-accessibility-features.png)
...
![Modulo debug del sistema tab plugin](../../../en/images/plugins/plugin-group-system/02-plugin-group-system-debug-plugin-tab.png)
...
![Modulo debug del sistema tab lingua](../../../en/images/plugins/plugin-group-system/03-plugin-group-system-debug-language-tab.png)
...
![Modulo debug del sistema tab registrazione](../../../en/images/plugins/plugin-group-system/04-plugin-group-system-debug-logging-tab.png)
...
![Modulo intestazioni HTTP del sistema](../../../en/images/plugins/plugin-group-system/05-plugin-group-system-http-headers.png)
...
![Modulo schedulatore di lavoro del sistema](../../../en/images/plugins/plugin-group-system/06-plugin-group-system-job-scheduler.png)
...
![Modulo statistiche di Joomla! del sistema](../../../en/images/plugins/plugin-group-system/07-plugin-group-system-joomla-statistics.png)
...
![Modulo notifica di aggiornamento di Joomla! del sistema](../../../en/images/plugins/plugin-group-system/08-plugin-group-system-joomla-update-notification.png)
...
![Modulo filtro lingua del sistema](../../../en/images/plugins/plugin-group-system/09-plugin-group-system-language-filter.png)
...
![Modulo rotazione dei log del sistema](../../../en/images/plugins/plugin-group-system/10-plugin-group-system-log-rotation.png)
...
![Modulo cache delle pagine del sistema](../../../en/images/plugins/plugin-group-system/11-plugin-group-system-page-cache.png)
...
![Modulo consenso alla privacy del sistema](../../../en/images/plugins/plugin-group-system/12-plugin-group-system-privacy-consent.png)
...
![Modulo consenso alla privacy del sistema scheda scadenza](../../../en/images/plugins/plugin-group-system/13-plugin-group-system-privacy-consent-expiration.png)
...
![Modulo di reindirizzamento del sistema](../../../en/images/plugins/plugin-group-system/14-plugin-group-system-redirect.png)
...
![Modulo SEF del sistema](../../../en/images/plugins/plugin-group-system/15-plugin-group-system-sef.png)
...
![Modulo pulizia dei dati di sessione del sistema](../../../en/images/plugins/plugin-group-system/16-plugin-group-system-session-data-purge.png)
...
![Modulo salta alla navigazione del sistema](../../../en/images/plugins/plugin-group-system/17-plugin-group-system-skip-to-navigation.png)

### Sistema - Registro delle Azioni degli Utenti

![Modulo registro delle azioni degli utenti del sistema](../../../en/images/plugins/plugin-group-system/18-plugin-group-system-user-actions-log.png)
...
![Modulo registro utenti del sistema](../../../en/images/plugins/plugin-group-system/19-plugin-group-system-user-log.png)
