<!--
{
  "source": "https://docs.joomla.org/Chunk4x:Extensions_Plugin_Manager_Edit_System_Group",
  "title": "Gruppo del Sistema ",
  "description": "", 
  "author": ""
}
-->
...
![Modulo delle funzionalità di accessibilità aggiuntive del sistema](../../../en/images/plugins/plugin-group-system/01-additional-accessibility-features.png)
...
![Modulo debug del sistema tab plugin](../../../en/images/plugins/plugin-group-system/02-debug-plugin-tab.png)
...
![Modulo debug del sistema tab lingua](../../../en/images/plugins/plugin-group-system/03-debug-language-tab.png)
...
![Modulo debug del sistema tab registrazione](../../../en/images/plugins/plugin-group-system/04-debug-logging-tab.png)
...
![Modulo intestazioni HTTP del sistema](../../../en/images/plugins/plugin-group-system/05-http-headers.png)
...
![Modulo schedulatore di lavoro del sistema](../../../en/images/plugins/plugin-group-system/06-job-scheduler.png)
...
![Modulo statistiche di Joomla! del sistema](../../../en/images/plugins/plugin-group-system/07-joomla-statistics.png)
...
![Modulo notifica di aggiornamento di Joomla! del sistema](../../../en/images/plugins/plugin-group-system/08-joomla-update-notification.png)
...
![Modulo filtro lingua del sistema](../../../en/images/plugins/plugin-group-system/09-language-filter.png)
...
![Modulo rotazione dei log del sistema](../../../en/images/plugins/plugin-group-system/10-log-rotation.png)
...
![Modulo cache delle pagine del sistema](../../../en/images/plugins/plugin-group-system/11-page-cache.png)
...
![Modulo consenso alla privacy del sistema](../../../en/images/plugins/plugin-group-system/12-privacy-consent.png)
...
![Modulo consenso alla privacy del sistema scheda scadenza](../../../en/images/plugins/plugin-group-system/13-consent-expiration.png)
...
![Modulo di reindirizzamento del sistema](../../../en/images/plugins/plugin-group-system/14-redirect.png)
...
![Modulo SEF del sistema](../../../en/images/plugins/plugin-group-system/15-sef.png)
...
![Modulo pulizia dei dati di sessione del sistema](../../../en/images/plugins/plugin-group-system/16-session-data-purge.png)
...
![Modulo salta alla navigazione del sistema](../../../en/images/plugins/plugin-group-system/17-skip-to-navigation.png)

### Sistema - Registro delle Azioni degli Utenti

![Modulo registro delle azioni degli utenti del sistema](../../../en/images/plugins/plugin-group-system/18-user-actions-log.png)
...
![Modulo registro utenti del sistema](../../../en/images/plugins/plugin-group-system/19-user-log.png)
