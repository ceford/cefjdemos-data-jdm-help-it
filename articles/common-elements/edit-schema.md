<!-- Filename: Help4.x:Edit_Schema / Display title: Modifica Schema -->
...
![Scheda dello schema con opzione articolo selezionata](../../../it/images/common-elements/edit-schema/01-schema-tab-article.png)

### Esempio: Schema Persona

![Scheda dello schema con opzione persona selezionata](../../../it/images/common-elements/edit-schema/02-schema-tab-person.png)
