...
![Tipo di Elemento del Menu Categoria Elenco - scheda layouts elenco](../../../it/images/menu-items-common/menu-item-list-layouts/01-articles-category-list-list-layouts-tab.png)
...
![Elemento del Menu Contatti in Evidenza scheda layouts elenco](../../../it/images/menu-items-common/menu-item-list-layouts/02-contacts-featured-contacts-list-layouts-tab.png)
...
![Elemento del Menu elenco tutte le Categorie dei Feed di Notizie scheda layouts](../../../it/images/menu-items-common/menu-item-list-layouts/03-news-feeds-list-layouts-tab.png)
...
![Elenco compatto degli elementi con tag scheda dettagli](../../../it/images/menu-items-common/menu-item-list-layouts/04-tags-list-layouts-tab.png)
