<!-- Filename: Help6.x:Menu_Item_Category / Display title: Categoria dell'Elemento del Menu -->
...
![Scheda della categoria dell'articolo del menu](../../../it/images/menu-items-common/menu-item-category/01-category-tab.png)
