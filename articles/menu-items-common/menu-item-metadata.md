<!-- Filename: Help6.x:Menu_Item_Metadata / Display title: Metadati dell'Elemento del Menu -->
...
![scheda metadati voce di menu](../../../it/images/menu-items-common/menu-item-metadata/01-metadata-tab.png)
