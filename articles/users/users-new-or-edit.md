...
![modifica dettagli utente tab](../../../it/images/users/users-new-or-edit/01-account-details-tab.png)
...
![scheda gruppi di utenti assegnati](../../../it/images/users/users-new-or-edit/02-assigned-user-groups-tab.png)

Il predefinito è *Registrato* ma può essere modificato nella pagina *Utente: Opzioni*.

### Impostazioni di Base

![scheda impostazioni di base](../../../it/images/users/users-new-or-edit/03-basic-settings-tab.png)
...
![scheda impostazioni di accessibilità](../../../it/images/users/users-new-or-edit/04-accessibility-settings-tab.png)
...
![scheda autenticazione multi-fattore](../../../it/images/users/users-new-or-edit/05-multi-factor-authentication-tab.png)
