<!-- Filename: Help4.x:User_Actions_Log / Display title: Registro delle Azioni dell'Utente -->
...
![log delle azioni degli utenti](../../../it/images/users/user-actions-log/01-log-list.png)
