<!-- Filename: Help4.x:User_Notes:_Categories / Display title: Note dell'Utente: Categorie -->
...
![elenco delle note degli utenti](../../../it/images/users/user-notes-categories/01-users-user-notes-categories-list.png)
